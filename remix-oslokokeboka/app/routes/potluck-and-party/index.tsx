...
export default function PotluckAndParty() {
  ...
  return (
    <div className="flex flex-col w-full md:w-[85%] md:max-w-[750px] md:mx-auto justify-center align-middle">
      <div className="bg-darkwine p-20 max-w-[530px] self-center flex flex-col gap-8">
